...
const Projects = () => {
    ...
    return (
        <div className="mt-40">
          <iframe className="w-32 top-[5.5rem] lg:left-[32rem] relative" src="https://lottie.host/embed/5a15d394-2bcb-493e-b70a-c2fbab655b55/6ThKMwg0XV.json"></iframe>
...
<div className="da relative flex  flex-col justify-center overflow-hidden bg-gray-50">
  ...
  <div className="group relative m-0 flex h-full w-[40rem] rounded-xl shadow-xl ring-gray-900/5 sm:mx-auto sm:max-w-lg">
    ...
    <div className="absolute bottom-0 z-20 m-0 pb-4 ps-4 transition duration-300 ease-in-out group-hover:-translate-y-1 group-hover:translate-x-3 group-hover:scale-110">
      <h1 className="font-serif text-3xl font-bold text-black shadow-xl">CareerFinder</h1>
      <h1 className="text-xl text-black font-medium shadow-xl">A job seeking website</h1>
    </div>
  </div>
</div>
